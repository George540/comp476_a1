...
it won't consider it as finding a closer dstance, so I disable it when I want to test the behaviours properly. I tried using the Toroidal distance
from DemoFox.org, but with no success. Check GameManager.cs on the last function to see my attempt.
